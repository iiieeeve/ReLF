...
class ReLF(nn.Module):
    def __init__(self,
        ...
        dim = eye_num_heads*eye_embd_dim
        ...
        self.eeg_prompt = nn.Parameter(torch.zeros(1, 5, eeg_input_dim))
    ...
    def no_weight_decay(self):
        return {"eeg_Transformer.pos_emb","eeg_Transformer.cls_token","eye_Transformer.pos_emb","eye_Transformer.cls_token"}
        
    def forward(self,eye):
        batch = eye.shape[0]
        eeg = self.eeg_prompt.expand(batch, -1, -1)
